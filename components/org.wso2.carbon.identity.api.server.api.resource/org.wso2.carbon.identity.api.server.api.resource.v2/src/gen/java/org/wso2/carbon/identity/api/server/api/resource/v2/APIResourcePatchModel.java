...
public class APIResourcePatchModel  {
    ...
    private List<AuthorizationDetailsTypesPatchModel> authorizationDetailsTypes = null;
    ...
    **/
    ...
    public APIResourcePatchModel addRemovedScopesItem(String removedScopesItem) {
        ...
        /**
    **/
    public APIResourcePatchModel authorizationDetailsTypes(List<AuthorizationDetailsTypesPatchModel> authorizationDetailsTypes) {
    ...
    @Valid
    public List<AuthorizationDetailsTypesPatchModel> getAuthorizationDetailsTypes() {
        return authorizationDetailsTypes;
    }
    public void setAuthorizationDetailsTypes(List<AuthorizationDetailsTypesPatchModel> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
    }

    public APIResourcePatchModel addAuthorizationDetailsTypesItem(AuthorizationDetailsTypesPatchModel authorizationDetailsTypesItem) {
        if (this.authorizationDetailsTypes == null) {
            this.authorizationDetailsTypes = new ArrayList<AuthorizationDetailsTypesPatchModel>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.name, apIResourcePatchModel.name) &&
            ...
            Objects.equals(this.authorizationDetailsTypes, apIResourcePatchModel.authorizationDetailsTypes);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, description, addedScopes, removedScopes, authorizationDetailsTypes);
    }
