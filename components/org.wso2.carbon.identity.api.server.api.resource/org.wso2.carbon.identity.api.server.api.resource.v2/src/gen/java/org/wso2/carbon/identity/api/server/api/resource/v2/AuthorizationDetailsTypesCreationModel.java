...
import org.wso2.carbon.identity.api.server.api.resource.v2.AuthorizationDetailsTypesCreationModelAllOf;
...
public class AuthorizationDetailsTypesCreationModel  {
    ...
    /**
    * an unique type of the authorization detail
    **/
    ...
    @ApiModelProperty(example = "payment_initiation", required = true, value = "an unique type of the authorization detail")
    @JsonProperty("type")
    @Valid
 ...
 @Size(min=1,max=255)
    ...
    /**
    * display name of the authorization detail
    **/
    ...
    @ApiModelProperty(example = "Payment Initiation", required = true, value = "display name of the authorization detail")
    @JsonProperty("name")
    @Valid
 ...
 @Size(min=3,max=255)
    ...
    /**
    * description of the authorization detail
    **/
    ...
    @ApiModelProperty(example = "Payment initiation authorization details type", required = true, value = "description of the authorization detail")
